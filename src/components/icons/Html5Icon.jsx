...
function Html5Icon({ className }) { // We accept `className` as a prop
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 48 48" // Keep the viewBox from your SVG
      className={className}  // Apply the passed className here
      // Remove x, y, width, and height attributes from here to allow Tailwind to control size
    >
